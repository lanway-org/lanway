...
/// Lanway palette — dark surfaces, sky-blue accent, white buttons. Uses the
/// platform's built-in font (no network font fetch — this app must work on
/// censored/offline networks). Shared look across the Manager and client apps.
class LanwayColors {
